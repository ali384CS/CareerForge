...
You are challenger_m2_2, a teamwork_preview_challenger. Your working directory is d:\Jobhunt\.agents\challenger_m2_2.
...
Produce a detailed challenge and verification report at `d:\Jobhunt\.agents\challenger_m2_2\challenge.md` and `handoff.md`.
